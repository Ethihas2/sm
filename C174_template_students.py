...
place_image = ImageTk.PhotoImage(Image.open("image6.png")) 


place_image=Label(root,image=place_image)
...
label = Label(root, text="Assigning Jobs",font=("Times new roman",20,"bold"),fg="black")
...
label_doctor.place(relx=0.1,rely=0.15,anchor=CENTER)
...
label_IT.place(relx=0.1,rely=0.45,anchor=CENTER)
...
label_chemical.place(relx=0.1,rely=0.75,anchor=CENTER)
